...
<body>
	...
	<form action="breply.do" method="post">
		...
		<table align="center" width="700" border="1" cellspacing="0"
			...
			<tr>
				<th width="120">제 목</th>
				<td><input type="text" name="boardTitle" size="70"></td>
			</tr>
			<tr>
				<th>작성자</th>
			...
			<tr>
				<th>내 용</th>
				<td><textarea name="boardContent" rows="5" cols="70"></textarea></td>
			</tr>
			<tr><th colspan="2">
				<input type="submit" value="등록하기">&nbsp; 
				<input type="reset" value="등록취소"> &nbsp; 
				<input type="button" value="목록" onclick="history.go(-1); return false;"> &nbsp;</th>
			</tr>
		</table>
	</form>
